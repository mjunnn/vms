...
import '../../styles/Resident/VisitorHistory.css';
...
function VisitorLogs() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      setUser(parsedUser);
      // For the resident dashboard, we allow access regardless of role.
      // If you need role-based logic, adjust here accordingly.
      axios
